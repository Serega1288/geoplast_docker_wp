...
$btn2_post_object = get_sub_field('btn2_link');

if ($btn1_text || $btn2_text) :
?>
	<section class="button_section_wrapper wrapper">
		<div class="button_container flex flex-center wrap_768 gap_20 animate fade-up" data-delay="100">
			...
			?>
				<a class="cta transparent_cta dark_text" href="<?php echo esc_url($btn2_url); ?>">
