...
$p_btn1_text    = get_field('product_button_text_1', $page_id);
$p_btn1_link    = get_field('product_button_link_1', $page_id);
$p_btn2_text    = get_field('product_button_text_2', $page_id);
$p_btn2_link_obj = get_field('product_button_link_2', $page_id);
		...
		<div class="grid col_2 gap_20">
			...
			?>
				<figure class="animate fade-up show" data-delay="<?php echo esc_attr($delay); ?>" style="width: 100%; min-width: 0;">
					<figcaption style="width: 100%; display: flex; flex-direction: column;">
						<a class="mask_prod" href="<?php echo esc_url($link); ?>"></a>
						<div class="product" style="width: 100%; display: flex; flex-direction: column;">
							<picture>
								<?php if ($img_url): ?>
									<img src="<?php echo esc_url($img_url); ?>" alt="" style="max-width: 100%; height: auto; display: block;">
								<?php endif; ?>
							</picture>
