<?php
$h_title    = get_sub_field('herosection_title');
$h_subtitle = get_sub_field('herosection_subtitle');
$h_bg       = get_sub_field('hero_bg');
$h_video    = get_sub_field('hero_video');

$btn_1_text = get_sub_field('btn_1_text');
$btn_1_link = get_sub_field('btn_1_link');
$btn_2_text = get_sub_field('btn_2_text');
$btn_2_link_obj = get_sub_field('btn_2_link');
