<?php
// Отримуємо головний заголовок секції
	...
	<?php if (have_rows('advant_list')) : ?>
		<div class="grid col_3 gap_30 adv_services">
			...
			while (have_rows('advant_list')) : the_row();
				// Отримуємо підполя з повторювача
				...
				// Налаштування анімації: перша картка fade-left, інші fade-up
				$anim_type = ($i === 0) ? 'fade-left' : 'fade-up';
				// Каскадна затримка для кожної наступної картки
				$delay = 150 + ($i * 100);
				$i++;
			?>
